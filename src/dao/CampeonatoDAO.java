...
public class CampeonatoDAO {
    ...
    public void adicionarCampeonato(Campeonato campeonato){
        try {
            ...
            st.executeUpdate("DECLARE BEGIN pack_campeonato.adicionar_campeonato ("+campeonato.getIdCampeonato()+",'"+campeonato.getDescricao()+"','"+campeonato.getAno()+"','"+campeonato.getNumEquipas()+"'); END;");
            st.close();
            con.close();
    ...
    public void actualizarCampeonato(Campeonato campeonato){
        try {
            ...
            Statement st= con.createStatement();
            st.executeUpdate("DECLARE BEGIN pack_campeonato.actualizar_campeonato ("+campeonato.getIdCampeonato()+",'"+campeonato.getDescricao()+"','"+campeonato.getAno()+"','"+campeonato.getNumEquipas()+"'); END;");
            st.close();
            con.close();
    ...
    public Object[][] listarCampeonato(){
        try {
            ...
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery("SELECT idCampeonato, descricao, ano, numequipa FROM campeonato ORDER BY idCampeonato");
            ...
            while(rs.next()){
                ...
                dados[linha++][3] = rs.getLong(4);//rs.getString("pessoa.email")
            }
            return dados;
        } catch (SQLException ex) {
