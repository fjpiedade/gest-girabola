 ...
 * frmEstadios.java
 *
 * Created on 10/11/2011, 14:02:56
 */
package view;
 ...
 */
public class frmEstadios extends javax.swing.JDialog {

    /** Creates new form frmEstadios */
    
    EstadioDAO daoEstadio = new EstadioDAO();
    
    private String[] cabecalho = {"Identificação", "Nome", "Lotação", "Local"};
    
    public frmEstadios(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void actualizaTabela(){
        Tabela.setModel(new DefaultTableModel(daoEstadio.listarEstadio(), cabecalho));
    }
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Estadios © 2011", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Trebuchet MS", 0, 18), new java.awt.Color(204, 204, 255))); // NOI18N
        ...
        Tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Identificação", "Nome", "Lotação", "Local"
            }
        ) {
    ...
    private void lbl_ProcurarMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_ProcurarMouseMoved
        ...
        lbl_Procurar.setBackground(Color.white);     }//GEN-LAST:event_lbl_ProcurarMouseMoved
    ...
    private void bt_AdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_AdicionarActionPerformed
        // TODO add your handling code here:
        frmAddEstadios Chamar =new frmAddEstadios(new javax.swing.JFrame(), true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmEstadios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                frmEstadios dialog = new frmEstadios(new javax.swing.JFrame(), true);
