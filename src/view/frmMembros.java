 ...
 * frmMembros.java
 *
 * Created on 16/11/2011, 01:07:28
 */
package view;
 ...
 */
public class frmMembros extends javax.swing.JDialog {
    ...
    public frmMembros(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void actualizaTabela(long idEquipa){
        ...
        Tabela.setModel(new DefaultTableModel(daoMembro.listarMembro(idEquipa), cabecalho));
    }
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Lista de Membros", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Trebuchet MS", 0, 18), new java.awt.Color(204, 204, 255))); // NOI18N
    ...
    private void bt_AdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_AdicionarActionPerformed
        /*
         frmAddTreinador Chamar = new frmAddTreinador(new javax.swing.JFrame(), true);         Chamar.setIdEquipa(lbl_Equipa.getText());         Chamar.setVisible(true);     }//GEN-LAST:event_bt_AdicionarActionPerformed
*/
         frmAddMembro Chamar = new frmAddMembro(new javax.swing.JFrame(), true);         
         Chamar.setIdEquipa(lbl_Equipa.getText());
         Chamar.setVisible(true);
    }
    private void jPanel3MouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel3MouseMoved

        lbl_Procurar.setBackground(new java.awt.Color(204, 204, 255));     }//GEN-LAST:event_jPanel3MouseMoved
/*  */
      ...
      public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                frmMembros dialog = new frmMembros(new javax.swing.JFrame(), true);
