...
/*
 * frmCartoesMostrados.java
 *
 * Created on 22/11/2011, 20:27:11
 */
package view;
 ...
 */
public class frmCartoesMostrados extends javax.swing.JDialog {

    CartaoDAO daoCartao= new CartaoDAO();
    private String[] cabecalho = {"Instante", "Cor","Motivo", "Número", "Número do Jogo"};
    
    /** Creates new form frmCartoesMostrados */
    public frmCartoesMostrados(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void actualizaTabela(long numFAF, long idEquipa){
        ...
        Tabela.setModel(new DefaultTableModel(daoCartao.listarCartao(numFAF,idEquipa), cabecalho));
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Cartões Mostrados © 2011");
        ...
        Tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Instante", "Cor", "Motivo", "Número", "Número do Jogo"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmCartoesMostrados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                frmCartoesMostrados dialog = new frmCartoesMostrados(new javax.swing.JFrame(), true);
