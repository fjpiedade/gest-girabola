 ...
 * frmAddMembro.java
 *
 * Created on 16/11/2011, 01:08:31
 */
package view;
 ...
 */
public class frmAddMembro extends javax.swing.JDialog {
    ...
    /** Creates new form frmAddMembro */
    public frmAddMembro(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Adicionar Membro © 2011");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Dados do Membro", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Trebuchet MS", 0, 18), new java.awt.Color(204, 204, 255))); // NOI18N
        ...
        cbo_Tipo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Delegado", "Médico Físico", "Médico Psíquiatrico", "Gestor de Imagem", "Outro" }));
    ...
    private void bt_AdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_AdicionarActionPerformed
        ...
        long idMembro= new MembroDAO().novoIdMembro()+1;
        Membro membro= new Membro(idMembro, Tipo, obs, bilhete_Identidade, idEquipa);
        daoMembro.adicionarMembro(membro);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmAddMembro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                frmAddMembro dialog = new frmAddMembro(new javax.swing.JFrame(), true);
