 ...
 * frmJogadores.java
 *
 * Created on 10/10/2011, 07:10:59
 */
package view;
 ...
 */
public class frmJogadores extends javax.swing.JDialog {

    JogadorDAO daoJogador = new JogadorDAO();
    ClubeDAO daoClube = new ClubeDAO();
    
    private String[] cabecalho = {"Nº da FAF", "Nome", "Bilhete de Identidade", "Telefone", "Posição", "e-Mail"};
    
    /** Creates new form frmJogadores */
    public frmJogadores(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void actualizaTabela(long idEquipa){
        ...
        Tabela.setModel(new DefaultTableModel(daoJogador.listarJogador(idEquipa), cabecalho));
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Jogadores © 2011");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Lista de Jogadores", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Trebuchet MS", 0, 18), new java.awt.Color(204, 204, 255))); // NOI18N
        ...
        Tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nº da FAF", "Nome", "Bilhete de Identidade", "Telefone", "Posição", "E-mail"
            }
        ) {
    ...
    private void lbl_verHistorialMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_verHistorialMouseClicked
        ...
        if (Tabela.getSelectedRowCount()==1){
            ...
            nomeJogador= Tabela.getValueAt(Tabela.getSelectedRow(),1).toString();
            numFAF1=Tabela.getValueAt(Tabela.getSelectedRow(),0).toString();
            ...
            frmHistorialJogadores Chamar =new frmHistorialJogadores(new javax.swing.JFrame(), true);
            Chamar.setNomeNumfaf(nomeJogador, numFAF);
            Chamar.actualizaTabela(numFAF);
    ...
    private void bt_AdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_AdicionarActionPerformed
        // TODO add your handling code here:
        frmAddJogador Chamar =new frmAddJogador(new javax.swing.JFrame(), true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmJogadores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                frmJogadores dialog = new frmJogadores(new javax.swing.JFrame(), true);
